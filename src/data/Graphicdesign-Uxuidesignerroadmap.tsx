    ...
    <div style={{ fontFamily: "'DM Sans',system-ui,sans-serif", background: "var(--cream)", color: "var(--ink)", overflowX: "hidden" }}>
      ...
      <section style={{ background: "linear-gradient(160deg,var(--cream) 0%,#fdf4ff 45%,#fff7ed 100%)", padding: "4.5rem 6% 3.5rem", borderBottom: "1px solid var(--rule)" }}>
        <div style={{ maxWidth: 800, margin: "0 auto" }}>
          ...
          {/* ✅ FIXED: now uses useNavigate() → navigate("/career-change") */}
          <button
            className="back-btn"
            onClick={() => navigate("/career-change")}
          >
          ...
          <h1
            ref={heroRef}
            className={heroIn ? "fade" : ""}
            style={{ fontFamily: "var(--fd)", fontSize: "clamp(2.4rem,5.5vw,4rem)", fontWeight: 800, lineHeight: 1.08, letterSpacing: "-.02em", marginBottom: "1.25rem", color: "var(--ink)" }}
          >
            From {PAGE.from}
            <br />
      ...
      <section style={{ padding: "4.5rem 6%", background: "var(--white)", borderTop: "1px solid var(--rule)" }}>
        <div style={{ maxWidth: 680, margin: "0 auto" }}>
          ...
          <div style={{ marginTop: "2.5rem", display: "flex", gap: "1rem", flexWrap: "wrap", alignItems: "center" }}>
            ...
            {/* ✅ Also using navigate here for consistency */}
            <button
              onClick={() => navigate("/career-change")}
              style={{ fontSize: ".9rem", fontWeight: 600, color: "var(--ink4)", textDecoration: "none", background: "none", border: "none", cursor: "pointer", fontFamily: "var(--fu)" }}
            >
              ← Browse All Paths
            </button>
          </div>
